...
| Модуль | Описание |
|--------|----------|
| **Беседки** | Онлайн-бронирование беседок с календарём доступности |
| **PlayStation Park** | Бронирование игровых столов |
...
- [x] Phase 1 — Беседки (бронирование, Telegram-бот, уведомления)
- [x] Phase 2 — PS Park, Кафе, Парковка, личный кабинет
