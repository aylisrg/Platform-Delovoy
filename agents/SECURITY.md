...
**Исключения по лицензиям (одобрены владельцем):**

- `web-push` (MPL-2.0) — допущена решением владельца от 2026-05-10 для реализации Web Push API. Библиотека используется без модификаций, что снимает требования copyleft (MPL-2.0 — file-level copyleft, обязательства касаются только модифицированных исходников самой библиотеки). Future MPL-2.0 зависимости требуют отдельного одобрения владельца.
