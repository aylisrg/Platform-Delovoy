...
export default defineConfig({
  ...
  expect: {
    toHaveScreenshot: {
      ...
      // #579 (смена цвета CTA-кнопки ~13000px, что вдвое больше потолка).
      // Калибровано по факту: остаточный AA-шум на реальном CI при
      // threshold=0.7 — максимум ~2744px (самая длинная/текстовая
      // страница, /gazebos), у остальных 8 страниц на порядок меньше.
      maxDiffPixels: 6000,
    },
  },
  use: {
