    ...
    try {
      const res = await fetch("/api/ps-park/admin-book", {
        ...
        body: JSON.stringify({
          ...
          clientName,
          clientPhone,
          ...(playerCount && { playerCount: parseInt(playerCount, 10) }),
          ...(comment && { comment }),
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {item.resource.capacity && (
                    <span className="text-xs text-zinc-400">до {item.resource.capacity} игр.</span>
                  )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="admin-players" className="block text-sm font-medium text-zinc-700 mb-1">
                  Кол-во игроков
                </label>
                <input
                  id="admin-players"
