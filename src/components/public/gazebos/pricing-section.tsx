      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-10">
          ...
          <p className="text-[#86868b] font-[family-name:var(--font-inter)] text-sm mt-3">
            ...
            Минимальное бронирование — 4 часа.
          </p>
          {/* Колонки «день» печатались без объяснения, когда они действуют.
              Правило — потолок, а не порог: клиент никогда не платит больше
              дневной ставки, поэтому лишний час после точки безубыточности
              бесплатен. Прайс на Сайте приоритетен (оферта, Приложение № 2). */}
          <p className="text-[#86868b] font-[family-name:var(--font-inter)] text-sm mt-2">
            Дневной тариф применяется автоматически: вы платите по часам, но не
            больше цены за день.
          </p>
        </div>
