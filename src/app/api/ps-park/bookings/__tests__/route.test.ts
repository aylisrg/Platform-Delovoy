...
function makeRequest(query: string) {
  return new NextRequest(`http://localhost/api/ps-park/bookings${query}`);
}
...
// listBookings() всегда возвращал один и тот же срез из 100 записей.
describe("GET /api/ps-park/bookings", () => {
