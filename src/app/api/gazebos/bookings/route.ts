...
import { listBookingsPaginated } from "@/modules/gazebos/service";
...
/**
 * GET /api/gazebos/bookings — list bookings with optional filters, paginated.
 * Каждая бронь обогащается derived-статусом оплаты (один батч-запрос по
 * полиморфной связи Payment↔Booking) для бейджа в админ-таблице.
 */
