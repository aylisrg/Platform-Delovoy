...
import { createAdminBooking, BookingError } from "@/modules/gazebos/service";
import { adminCreateBookingSchema } from "@/modules/gazebos/validation";

/**
 * POST /api/gazebos/admin-book — admin creates booking on behalf of client
