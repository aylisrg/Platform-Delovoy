...
export default async function NedelovoyEmailTemplatesPage() {
  ...
  return (
    <>
      <AdminHeader title="НеДеловой — шаблоны писем" />
                ...
                <div key={t.key} className="py-4 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <Link
                        href={`/admin/nedelovoy/email-templates/${encodeURIComponent(t.key)}`}
