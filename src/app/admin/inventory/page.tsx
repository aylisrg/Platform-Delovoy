...
export default function InventoryPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-900">Склад — Приход товаров</h1>
        <p className="mt-1 text-sm text-zinc-500">
          Записывайте поступление товаров. Новый товар создаётся автоматически.
        </p>
      </div>

      <InventoryReceiveForm onSuccess={() => setRefreshKey((k) => k + 1)} />
