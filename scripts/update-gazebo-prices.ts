...
const GAZEBOS: Array<{
...
}> = [
  {
    ...
    capacity: 20,
    pricing: { weekdayHour: 1100, weekdayDay: 11000, weekendHour: 1500, weekendDay: 14000 },
  },
  {
    name: "Беседка №2",
    description: "Беседка с отоплением, до 12 человек",
    capacity: 12,
    pricing: { weekdayHour: 800, weekdayDay: 7000, weekendHour: 1100, weekendDay: 10000 },
  },
  {
    name: "Беседка №3",
    description: "Беседка с отоплением, до 12 человек",
  ...
  },
  {
    ...
    capacity: 30,
    pricing: { weekdayHour: 1400, weekdayDay: 13000, weekendHour: 2000, weekendDay: 16000 },
